<%@ page title="" language="C#" masterpagefile="~/MasterPageNew.master" autoeventwireup="true" inherits="WebForm_frmCompanyCreation, Root" %>
                        ...
                        <asp:MultiView ID="MultiView1" runat="server">
                            <asp:View ID="View1" runat="server">
                                <asp:Panel ID="Panel2" runat="server" GroupingText="Company List">
                                     <asp:ImageButton ID="btnAddNew" runat="server" Height="35px" ImageUrl="~/images/add_new_btn2.jpg" onclick="btnAddNew_Click" Width="130px" />
